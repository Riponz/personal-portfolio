...
function SelfBanner() {
    return (
        <>
            <div id='info' className="main z-0 mt-8 flex md:flex-col md:items-center justify-center items-center md:py-5 overflow-hidden w-full h-[30rem] md:h-fit ">
            <img className='self relative md:w-[15rem] aspect-square rounded-[50%] z-[0] grayscale' src={selfImg} alt="" />
                <div className="details w-[35rem] md:w-[20rem] overflow-hidden h-fit flex flex-col justify-center items-start md:mt-5 ml-[10px] md:items-center">
