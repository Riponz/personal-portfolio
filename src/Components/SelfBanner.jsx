    ...
    return (
        <>
            <div className="main flex md:flex-col md:items-center justify-center items-start overflow-hidden w-[100%] h-80 ">
                <div className='md:rounded-[100%] md:flex md:justify-center md:items-start md:w-[250px] md:h-[300px] md:border-solid md:border-white md:overflow-hidden'><img className='self md:w-56' src={selfImg} alt="" /></div>
